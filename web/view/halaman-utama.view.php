...
<div class="container" id="data-rumah">
	...
	<div class="col-md-12">
		<a href="selengkapnya" class="selengkapnya btn btn-info">Selengkapnya <span class="glyphicon glyphicon-play"></span></a>
	</div>
</div>
<div class="container" id="data-rumah">
	<center>
		...
		<div class="col-md-4 col-sm-6 col-xs-6">
			<div class="row thumb">
				<a href="#" class="thumbnail">
					...
					<div class="bawah-progress">
						<div class="col-md-12">
							<div class="col-md-3 col-sm-3 col-xs-4"><h6>100% </h6><label>Terkumpul</label></div>
							<div class="col-md-6 col-sm-6 col-xs-4"><h6>Rp. 12.000.000.-</h6><label>Diperlukan</label></div>
							<div class="col-md-3 col-sm-3 col-xs-4"><h6>200 </h6><label>Orang</label></div>
						</div>
					</div>
				</a>
				<a class="detail-donasi" href="?hal=masuk"><button class="btn btn-info" onclick="">Donasi!</button></a>
